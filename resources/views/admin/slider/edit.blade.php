                ...
                <div class="white_box mb_30">
                    ...
                    <form action="{{route('admin.slider.update',['id' => $slider->id])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control my-editor @error('title') is-invalid @enderror" name="title" rows="4">{{$slider->title}}</textarea>
                            @error('title')
                        ...
                        <div class="image mb-2">
                            <img src="{{($slider->image)}}" alt="" width="200px" height="200px">

                        </div>
                        @endif
                        <label class="form-label mb-2 mt-2">Ảnh slider</label>
                        <div class="input-group">
                            <input type="file" class="form-control @error('image_slider') is-invalid @enderror" name="image_slider">
                        </div>
                        @error('image_slider')
                        <div class="message-error">{{ $message }}</div>
                        @enderror
