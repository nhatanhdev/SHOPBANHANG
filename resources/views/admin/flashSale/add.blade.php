                ...
                <form action="{{route('admin.flashSale.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="mb-3 col-lg-6  common_date_picker mb_20">
                            ...
                            <input class="input_form" id="start_datepicker" name="start_date" placeholder="pick a date" >
                        </div>
                        <div class="mb-3 col-lg-6  common_date_picker mb_20">
                            <label class="form-label">Thời Gian Kết Thúc</label>
                            <input class="input_form" id="end_datepicker" name="end_date" placeholder="pick a date" >
                        </div>
