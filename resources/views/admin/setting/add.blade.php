                ...
                <div class="white_box mb_30">
                    ...
                    <form action="{{route('admin.setting.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control my-editor @error('config_value') is-invalid @enderror" name="config_value" rows="4">{{old('config_value')}}</textarea>
                            @error('config_value')
                            <div class="message-error">{{ $message }}</div>
                            @enderror
                        </div>
